...
<template>
  <main class="flex flex-col items-center justify-center px-10 space-y-10">
    ...
    <button @click="copyEmail" class="button">Copier l'adresse email</button>
    <p>
      <strong class="text-true">{{ showSuccesMessage ? 'Mail copié !' : '&nbsp;' }}</strong>
    </p>
    <ToolsboxFullSvg />
  </main>
</template>
